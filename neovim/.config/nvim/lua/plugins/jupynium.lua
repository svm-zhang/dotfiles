return {
	{ "kiyoon/jupynium.nvim", build = "rye install jupynium" },
	...
	config = function()
		...
		jupynium.setup({
			...
			python_host = vim.g.python3_host_prog or "rye run python",
			...
			firefox_profiles_ini_path = "$HOME/snap/firefox/common/.mozilla/firefox/profiles.ini",
